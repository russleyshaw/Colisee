...
class Logger {
    ...
    static create(message, location, severity, time_created, callback) {
        ...
        pgclient.connect(function(err){
            ...
            pgclient.query("INSERT INTO log (message, location, severity, time_created) VALUES ($1::text, $2::text, $3, current_timestamp() ) RETURNING *", [message, location, severity], function (err, result) {
                if(err) { callback(err); return; }
